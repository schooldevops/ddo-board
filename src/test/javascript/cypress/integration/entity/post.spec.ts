...
describe('Post e2e test', () => {
  ...
  it('should create an instance of Post', () => {
    ...
    cy.get(`[data-cy="createdAt"]`).type('2021-05-26T12:57').invoke('val').should('equal', '2021-05-26T12:57');

    cy.get(`[data-cy="createdBy"]`).type('75612').should('have.value', '75612');

    cy.get(`[data-cy="modifiedAt"]`).type('2021-05-26T14:40').invoke('val').should('equal', '2021-05-26T14:40');

    cy.get(`[data-cy="modifiedBy"]`).type('31035').should('have.value', '31035');
