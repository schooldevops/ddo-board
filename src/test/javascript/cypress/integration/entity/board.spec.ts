...
describe('Board e2e test', () => {
  ...
  it('should create an instance of Board', () => {
    ...
    cy.get(`[data-cy="createdAt"]`).type('2021-05-26T08:10').invoke('val').should('equal', '2021-05-26T08:10');

    cy.get(`[data-cy="createdBy"]`).type('70192').should('have.value', '70192');

    cy.get(`[data-cy="modifiedAt"]`).type('2021-05-26T04:34').invoke('val').should('equal', '2021-05-26T04:34');
