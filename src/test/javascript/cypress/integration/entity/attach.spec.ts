...
describe('Attach e2e test', () => {
  ...
  it('should create an instance of Attach', () => {
    ...
    cy.get(`[data-cy="createdAt"]`).type('2021-05-27T00:51').invoke('val').should('equal', '2021-05-27T00:51');

    cy.get(`[data-cy="createdBy"]`).type('16266').should('have.value', '16266');

    cy.get(`[data-cy="modifiedAt"]`).type('2021-05-26T14:58').invoke('val').should('equal', '2021-05-26T14:58');
