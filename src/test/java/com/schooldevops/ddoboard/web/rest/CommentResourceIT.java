...
import static com.schooldevops.ddoboard.web.rest.TestUtil.sameInstant;
...
import com.schooldevops.ddoboard.domain.Comment;
import com.schooldevops.ddoboard.repository.CommentRepository;
import com.schooldevops.ddoboard.service.dto.CommentDTO;
import com.schooldevops.ddoboard.service.mapper.CommentMapper;
...
class CommentResourceIT {
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.depth(UPDATED_DEPTH).comment(UPDATED_COMMENT).readCnt(UPDATED_READ_CNT).badCnt(UPDATED_BAD_CNT);
