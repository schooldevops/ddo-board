...
/**
 * REST controller for managing {@link com.schooldevops.ddoboard.domain.AttachGroup}.
 */
@RestController
@RequestMapping("/api")
public class AttachGroupResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/attach-groups/{id}", consumes = "application/merge-patch+json")
    ...
    public ResponseEntity<List<AttachGroupDTO>> getAllAttachGroups(Pageable pageable) {
