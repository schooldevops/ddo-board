...
/**
 * REST controller for managing {@link com.schooldevops.ddoboard.domain.Attach}.
 */
@RestController
@RequestMapping("/api")
public class AttachResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/attaches/{id}", consumes = "application/merge-patch+json")
     ...
     */
    @GetMapping("/attaches")
    public ResponseEntity<List<AttachDTO>> getAllAttaches(Pageable pageable) {
