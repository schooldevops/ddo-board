package com.schooldevops.ddoboard.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.schooldevops.ddoboard.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.schooldevops.ddoboard.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.schooldevops.ddoboard.domain.Comment.class.getName());
            createCache(cm, com.schooldevops.ddoboard.domain.Comment.class.getName() + ".comments");
