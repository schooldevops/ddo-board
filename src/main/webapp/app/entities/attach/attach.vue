  ...
  <div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('ord')">
              <span>Ord</span> <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'ord'"></jhi-sort-indicator>
            </th>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="ddoboardApp.attach.delete.question" data-cy="attachDeleteDialogHeading">Confirm delete operation</span></span
      >
