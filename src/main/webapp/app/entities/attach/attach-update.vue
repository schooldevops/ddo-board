  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2 id="ddoboardApp.attach.home.createOrEditLabel" data-cy="AttachCreateUpdateHeading">Create or edit a Attach</h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" for="attach-ord">Ord</label>
            <input
              type="number"
              class="form-control"
              name="ord"
              id="attach-ord"
              data-cy="ord"
              :class="{ valid: !$v.attach.ord.$invalid, invalid: $v.attach.ord.$invalid }"
              v-model.number="$v.attach.ord.$model"
            />
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input
              ...
              v-model.number="$v.attach.createdBy.$model"
              required
            />
            <div v-if="$v.attach.createdBy.$anyDirty && $v.attach.createdBy.$invalid">
              ...
              <small class="form-text text-danger" v-if="!$v.attach.createdBy.numeric"> This field should be a number. </small>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input
              ...
              v-model.number="$v.attach.modifiedBy.$model"
            />
          </div>
          <div class="form-group">
