  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2 id="ddoboardApp.attachGroup.home.createOrEditLabel" data-cy="AttachGroupCreateUpdateHeading">Create or edit a AttachGroup</h2>
        <div>
          ...
          <div class="form-group">
            ...
            <input
              ...
              v-model.number="$v.attachGroup.createdBy.$model"
              required
            />
            <div v-if="$v.attachGroup.createdBy.$anyDirty && $v.attachGroup.createdBy.$invalid">
              ...
              <small class="form-text text-danger" v-if="!$v.attachGroup.createdBy.numeric"> This field should be a number. </small>
            </div>
          </div>
          <div class="form-group">
