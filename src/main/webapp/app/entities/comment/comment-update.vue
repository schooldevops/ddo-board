  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2 id="ddoboardApp.comment.home.createOrEditLabel" data-cy="CommentCreateUpdateHeading">Create or edit a Comment</h2>
        <div>
          ...
          <div class="form-group">
            ...
            <input
              ...
              v-model.number="$v.comment.createdBy.$model"
              required
            />
            <div v-if="$v.comment.createdBy.$anyDirty && $v.comment.createdBy.$invalid">
              ...
              <small class="form-text text-danger" v-if="!$v.comment.createdBy.numeric"> This field should be a number. </small>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input
              ...
              v-model.number="$v.comment.modifiedBy.$model"
            />
          </div>
          <div class="form-group">
