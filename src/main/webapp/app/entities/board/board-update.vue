  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2 id="ddoboardApp.board.home.createOrEditLabel" data-cy="BoardCreateUpdateHeading">Create or edit a Board</h2>
        <div>
          ...
          <div class="form-group">
            ...
            <input
              ...
              v-model.number="$v.board.createdBy.$model"
              required
            />
            <div v-if="$v.board.createdBy.$anyDirty && $v.board.createdBy.$invalid">
              ...
              <small class="form-text text-danger" v-if="!$v.board.createdBy.numeric"> This field should be a number. </small>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input
              ...
              v-model.number="$v.board.modifiedBy.$model"
            />
          </div>
        </div>
        <div>
